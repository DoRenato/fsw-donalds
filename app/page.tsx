...
export default async function Home() {
  ...
  return (
    <main className="container mx-auto min-h-dvh bg-white">
      <div className="flex w-full flex-col items-center justify-center gap-2 bg-red-600 px-5 pb-6 pt-10">
        <Utensils className="h-12 w-12 text-white" />
        <h1 className="py-5 pb-10 text-2xl font-semibold text-white">
      ...
      <div className="relative z-50 mt-[-25] flex flex-col rounded-t-xl bg-white px-5">
        ...
        <div className="flex flex-col gap-5">
          {restaurants.map((restaurant) => (
            <Card key={restaurant.id} className="mx-auto w-full max-w-sm border-gray-300">
              <CardHeader>
